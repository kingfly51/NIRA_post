# NIRA_post
The full set of code from the Simulation Intervention for Cross-Sectional Network Models: Based on the R Packages NodeIdentifyR and NIRApost article is stored here and is mainly used to perform single network NIRA and dual network NIRA. Among them, the single_gds_NIRA.R file is the complete set of code appearing in the article, and the Supplementary Material Code. R is the code used in the supplementary materials of the article.
