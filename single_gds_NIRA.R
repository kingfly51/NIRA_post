...
#####1.7 Simulation intervention based on NodeIdentifyR algorithm######
...
stat_result <- permutationNIRAtest(gs_sumIsingSamplesLong, method = "bonferroni")
...
# Parallel
Bootresult <- stabilityNIRAtest(edge_weights = edgeWeightMatrix,
                                thresholds = thresholdVector,
                                perturbation_type = "aggravating",
                                amount_of_SDs_perturbation = 2,
                                nboots = 10,
                                ...
                                seed = 2025)
# Serial
#Bootresult_serial <- stabilityNIRAtest(edge_weights = edgeWeightMatrix,
#                                       thresholds = thresholdVector,
#                                       perturbation_type = "aggravating",
#                                       amount_of_SDs_perturbation = 2,
#                                       nboots = 100,
